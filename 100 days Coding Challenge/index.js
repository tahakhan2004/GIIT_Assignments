...
var invalidIndex = 3; // This index is invalid because the array has only 3 elements
var color = colors[invalidIndex]; // This line will cause an index error
...
var make_shirt = function (size, design) {
    if (design === void 0) { design = "sehri ka scene on"; }
    console.log("The size of this T-shirt is ".concat(size, " and print is ").concat(design));
};
...
var output1 = cityCountry('Lahore', 'Pakistan');
console.log(output1);
var output2 = cityCountry('New York', 'USA');
console.log(output2);
var output3 = cityCountry('Tokyo', 'Japan');
console.log(output3);
...
var album1 = makeAlbum('Artist 1', 'me gane nhi sunta');
